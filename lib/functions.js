...
function parseAlarmData (str) {
	var termInfoContent,voltLevel,gsmSignal,lang;
	var termInfoByte = str.substr(0,2);
	var teminfoBit = parseInt(termInfoByte,) 
	{
			"termInfoContent": str.substr(54,2),
			"voltLevel"		 : str.substr(56,2),
			"gsmSignal" 	 : str.substr(58,2),
			"lang"			 : str.substr(60,4),	
		}
}
function crc16(buf){
    var crcTable = 
...
exports.getParsedStatusData = function (str) {
	var data= {
			"termInfoContent": str.substr(0,2),
			"voltLevel"		 : str.substr(2,2),
			"gsmSignal" 	 : str.substr(4,2),
			"lang"			 : str.substr(6,4),	
		}
	return data;	
}
