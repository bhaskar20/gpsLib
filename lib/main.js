...
function Device(adapter,connection,gps_server){
	...
	****************************************/
	this.on("data",function(data) {
		...
		msg_parts = this_device.adapter.parse_data(data.toString());
		...
		if(typeof(msg_parts.protocolNumber) == "undefined")throw "The adapter doesn't return the command (cmd) parameter";
		/************************************
		EXECUTE ACTION
		************************************/
